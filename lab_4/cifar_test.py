import time
import torch.optim
from dataset import MNISTMetricDataset, CIFARMetricDataset
...
if __name__ == '__main__':
    ...
    ds_train = CIFARMetricDataset(mnist_download_root, split='train')
    ds_test = CIFARMetricDataset(mnist_download_root, split='test')
    ds_traineval = CIFARMetricDataset(mnist_download_root, split='traineval')
    ...
    emb_size = 128
    model = SimpleMetricEmbedding(3, emb_size,margin=1).to(device)
